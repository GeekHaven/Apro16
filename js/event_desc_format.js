var allevents = {
	...
	'Wekriti':{
						'rule':'1.Contestants can participate individually or in a team of two.<br>2.The theme for the event will be disclosed ,few hours prior to the start of the event.<br>3.The event judging will be done online.<br>4.Contestants have to host their work online (Eg.using gh-pages (github), codepen, jsfiddle ) and mail the links to irm2014004@iiita.ac.in.<br>5.For more information on using gh-pages , follow the link - https://pages.github.com/.<br>6.Use of frameworks such as bootstrap, jquery,materialize CSS is allowed. You may refer to other templates,websites for reference. However, code duplication is prohibited and will lead to disqualification.<br>7.Contestants are required to make separate files for CSS, JS, jquery etc. for structured code.<br>',
						'description':'Webkriti is a theme based UI design contest for front-end developers. ',
						'contacts':'Bharat Gupta IIT2014156 - 9045907587<br>Yogesh Gupta IRM2014004 - 9404173123<br>Ajay Pilaniya IRM2014007- 9783123208<br>M Dileep     IIT2015035  -   9628386148<br>'
					},
	'Eureka':{
						'rule':' i) Use Android studio to build the apps<br>ii) Use of third party libraries is allowed, but some modification should be made while using it.<br>iii) It is a single member event, no team submission is allowed.<br>iv) More info will be provided at the time of contest.<br>',
	...
	'Infinitum':{
						'rule':'1.The contest will be of 24hrs duration with around 30 problems of varying difficulty.<br>2.It is an individual event.<br>3.Input for each question will be provided. You just need to submit the corresponding output.<br>4.You can make any number of submissions for the problem.<br>5.You can proceed to next problem only if you have solved current problem.<br>6.Each question will have some points which will be rewarded if you have solved that problem.<br>7.The total score of any participant is the sum of their scores of each of the attempted problems. <br>8.Participants are ranked according to their scores. Cumulative time taken to solve the challenge is used as a tie-breaker.<br>9.Top 3 participants and top participant from 1st year of IIIT Allahabad will be awarded with cash prizes.<br>',
						'description':' Infinitum is a mathematical contest of Aparoksha, the annual technical festival of IIIT Allahabad. It is an online mathematical event which gives you a great opportunity to try your hands on some exciting mathematical problems.Mathematics, here is only a means and not an end. A sound knowledge of coding is also required. So put on your thinking caps and gear up, it\'s time to unleash the mathematician in you.',
						'contacts':'K Ashwin  - 8953345669 - IIT2013133<br>Neeraj Agarwal - 8853431306 - IIT2013189<br>Manan Jain - 8808724223 - IEC2013059<br>Shiv Dhingra - 8858840981 - IIT2013037<br>'
					},				
	'TreasureHunt':{
						'rule':'1) It\'ll be played with teams of 3 members. Each team has to announce a leader at the time of registration.<br>2) Hunt will be conducted in 4 rounds. 30 teams are selected from 1st round and 20 teams will be selected from 2nd round. Round 3 will be conducted in 3 phases and only 10 teams will proceed to the Final hunt.<br>3) In case, if no team is able to find the treasure, then team with maximum number of clues with solution will be selected as winner.<br>4) All the team members of each team cannot keep any kind of cash or ATM with them.<br>5) There is a time limit of 1 n half hours for each, for all the competing teams to find the treasure.<br>6) The clues are to be found in a particular order. A team cannot skip a clue. Skipping a clue leads to disqualification of the team.<br>7) If you found other teamâ€™s clue by any chance never tamper it. A violation of this rule could cause disqualification of your team.<br>8) Do not search for clues in off-limit areas. If you move anything to search an area, put it back the way it was before you leave.<br>9) An entire team must stay together. It cannot split up to find different clues. If a team splits, it will be penalized by a point penalty and after 3 penalty points, team will be disqualified.<br>10) All the means used by the teams should be fair, in case of any violation of the rules or any use of unfair means, teams will be disqualified from the contest.',
						'description':'This is hunt for the treasures and their clues those are hidden in our college premises itself.',
						'contacts':'Dikshant Devkota IIT2013002  0918795897995<br>Sachin Pokharel IIT2013009  0918176027461 <br>Vannepuri Praveen IIT2013072  0917607459468 <br>Pukar Sapkota IIT2013177 0919648466615 <br>Akash Yadav IIT2013207 0917706067001 <br>Saurav Jha IEC2013085 0919026566483'
					},
	'FbSharingContest':{
	...
	'Logo':{
						'rule':'1.Individual participation.<br>2.The theme for the event will be disclosed ,few hours prior to the start of the event.<br>3.Contestants can use any software platform for designing.<br>4.Contestant have to mail the design ( in .png / .jpg and .psd for (Resolution of 300 dpi)) to iec2014025@iiita.ac.in.<br>5.The design should be dynamic, unique, creative, and incorporate the text and graphics provided with theme.<br>6.The logo may incorporate other imagery, abstract symbols or a catchphrase.<br>',
						'description':'Get creative and earn prizes by designing logo for the given theme.<br><br><b>Prize : Rs 5000</b><br>1st - 3000 ; 2nd - 1000 ; 3rd - 500',
						'contacts':'Sugandh Sagar - iec2014025 - 7379301701<br>Bharat Gupta - iit20140156 - 9045907587<br>Aryan Gupta - iit2014008 <br>'
					},
	'BlackBox':{
	...
	'BackBone':{
						'rule':'<ul><li>In case of plagiarism, the team will be disqualified.</li><li>Usage of internet is not allowed.</li><li>The final verdict will be on the discretion of the Organisers, and will be indisputably final.</li><li>Time Allotted will be 4 hours Â­ Round 1 Â­> 1 hour, Round 2Â­> 3 Hour</li></ul>',
						'description':'Design and develop the backend of a webpage and show your skills as a master.The participants have to make a web App with backend in SQL/NoSQL using minimum front end to design of the given topic.There will be given onsite.Rough sketch of the backend should be presented within the first hour.<br>Points:<br><ul><li>creativity : 30</li><li>Response Time : 20</li><li>Extra features: 5 points for each extra substantial features. Maximum marks Â­ 30</li><li>Database design:50</li><li>Security:20</li></ul>',
						'contacts':'<ul><li>Gautham Santhosh : 8281896007</li><li>Ajay pilaniya : 9783123208 </li> <li>Akshat Aggarwal : 9838206921 </li></ul>'
					},
	'PencilSketching':{
						'rule':'<ul><li>Single participant.</li><li>Time:1hour</li><li>Weâ€™ll be providing pencils and A4 sheets</li><li>Evaluation criteria:<ul><li>Facebook likes Â­ 40%</li><li>organizers Â­ 40%</li><li>judges Â­ 20%</li></ul></li></ul>',
	...
	'TechnoFault':{
						'rule':'Individual event<br>Number of rounds: 3<br>Open to all<br><ul><li><b>1st round:</b><br> Multiple Choice Questions(Qualifier round)<br>Common for all<br>Separate cutoffs for each year<br></li><b>2nd round:</b><br> 1st year Â­ Circuit Debugging<br>2nd year Â­ Microcontroller code debugging<br>3rd year and rest Â­ Verilog code debugging <br></li><li><b>3rd round:</b><br> Debug the given circuit. Implement it on the breadboard and MultiSim<br>Common for all</li></ul>',
